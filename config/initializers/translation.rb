...
class Translation
  ...
  MS_TRANSLATOR_PRIMARY_KEY      = CONF['MS_TRANSLATOR_PRIMARY_KEY']
  # クライアントID see: https://datamarket.azure.com/developer/applications/
  MS_TRANSLATOR_CLIENT_ID        = CONF['MS_TRANSLATOR_CLIENT_ID']
  # クライアントID see: 顧客の秘密
  MS_TRANSLATOR_CLIENT_SECRET    = CONF['MS_TRANSLATOR_CLIENT_SECRET']
